...
FIELD_LABELS = {
    ...
    'block_when_log_on': 'log on 时拦截 AI（不进前置）',
    ...
    'allow_multiple_agents_in_group': '允许同群多个 Agent 并行',
    ...
    'busy_reply': '忙时回复',
    'error_reply': '错误回复',
    'qqguild_auto_markdown': 'QQGuild v2 自动发送 Markdown',
    'quote_reply': '允许 AI 自主引用消息',
...
PATH_LABELS = {
    ...
    ('research', 'max_queries'): '单轮最多搜索词条数',
    ('research', 'max_urls'): '单轮最多抓取网页数',
    ('research', 'max_results'): '每条搜索词结果上限',
    ('research', 'allow_fetch'): '允许前置抓取网页正文',
    ('research', 'page_max_chars'): '网页正文送入压缩的字符上限',
    ('research', 'readonly_tools'): '只读工具也交给前置执行',
    ('research', 'summary_max_chars'): '结论字数上限',
    ('research', 'prefer_provider_answer'): '优先采用搜索服务自带结论',
    ('research', 'timeout_sec'): '前置检索模型超时（秒）',
