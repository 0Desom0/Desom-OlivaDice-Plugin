...
· 文件大小：{file_size}''',
    ...
    'reply_multiple_footer': '请输入对应序号查询对应的 I Wanna。',
    ...
    'reply_paged_footer': '请输入对应序号查询对应的 I Wanna，或输入下一页/上一页/跳页[页数]进行翻页。',
    'reply_input_invalid': '请输入严格的数字序号。',
    'reply_paged_input_invalid': '请输入严格的数字序号，或者输入下一页/上一页/跳页[页数]进行翻页。',
...
custom_message_note_dict = {
    ...
    'reply_paged_footer': '【分页页脚】结果多于一页时的输入提示。',
    'reply_input_invalid': '【选择输入错误】非分页列表中输入非数字时回复。',
    'reply_paged_input_invalid': '【分页输入错误】分页列表中输入非数字且不是翻页词时回复。',
